...
def set_optimizer(model, defs):
    ...
    elif defs.optimizer == 'signSGD':
        optimizer = optimizers.signSGD(model.parameters(), lr=defs.lr)
    elif defs.optimizer == 'DPsignSGD':
        optimizer = optimizers.DPsignSGD(model.parameters(), lr=defs.lr)
    elif defs.optimizer == 'signNum':
        optimizer = optimizers.signNum(model.parameters(), lr=defs.lr,weight_decay=defs.weight_decay)
    if defs.scheduler == 'linear':
