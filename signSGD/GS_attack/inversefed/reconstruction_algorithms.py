...
class GradientReconstructor():
    ...
    def _run_trial(self, x_trial, input_data, labels, dryrun=False):
        ...
        if self.reconstruct_label:
            ...
            elif  self.config['optim'] == 'signSGD':
                optimizer = optimizers.signSGD([x_trial, labels],lr=0.01)
            elif  self.config['optim'] == 'DPsignSGD':
                optimizer = optimizers.DPsignSGD([x_trial, labels],lr=0.01)    
            elif self.config['optim'] == 'signNum':
                optimizer = optimizers.signNum([x_trial, labels],lr=0.01,momentum=0.9)
